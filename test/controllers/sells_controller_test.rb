...
class SellsControllerTest < ActionController::TestCase
  ...
  test "should create sell" do
    assert_difference('Sell.count') do
      post :create, sell: { collegename: @sell.collegename, email: @sell.email, name: @sell.name, noofbooktosell: @sell.noofbooktosell, phnumber: @sell.phnumber, refer: @sell.refer }
    end
  ...
  test "should update sell" do
    patch :update, id: @sell, sell: { collegename: @sell.collegename, email: @sell.email, name: @sell.name, noofbooktosell: @sell.noofbooktosell, phnumber: @sell.phnumber, refer: @sell.refer }
    assert_redirected_to sell_path(assigns(:sell))
  end
